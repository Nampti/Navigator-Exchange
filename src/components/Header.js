                  ...
                  <span className="More">
                    ...
                    <div className="show-dropdown">
                      <div className="show-dropdown-menu">
                        ...
                        <NavLink className="menu-item-container" to="/stake">
                          <div className="menu-item">
            ...
            <div className="App-header-user">
              <div className="App-header-trade-link">
                <NavLink
                  ...
                  to="https://app.navigator.exchange/#/trade"
                >
            ...
            <div className="App-header-container-right">
              <div className="App-header-user">
                <div className="App-header-trade-link homepage-header">
                  <NavLink className="default-btn" to="/">
                    <span>Launch App</span>
                  </NavLink>
                </div>
              </div>
      ...
      >
        <div className="App-header-links menu">
          ...
          >
            ...
            <div className={`App-show-down ${miniMenuActive ? "active" : ""}`}>
              <div
                className={`show-down-item-container ${
                  location.pathname === "/" ? "active" : ""
                }`}
              >
                <NavLink className="show-down-item" to="/">
                  <img src={MenuItem1} alt="" />
              ...
              <div
                className={`show-down-item-container ${
                  location.pathname === "/stake" ? "active" : ""
                }`}
              >
                <NavLink className="show-down-item" to="/stake">
                  <img src={MenuItem2} alt="" />
                  <div class="show-down-wrap">
                    <span>Stake NAVI & esNAVI</span>
                    <span class="desc">Stake Navigator governance token</span>
                  </div>
                </NavLink>
              </div>
              <div
